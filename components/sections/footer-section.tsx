...
function FlippingTel({ email }: { email: string }) {
  const [isFlipped, setIsFlipped] = useState(false);
        ...
        <div className="flex flex-col items-center justify-center text-center w-full">
          ...
          <span className="font-nohemi text-xs font-medium uppercase tracking-[0.3em] text-white/40 mb-8">
			...
			<p className="font-nohemi text-lg md:text-xl text-white/50 max-w-lg mb-12">
			  Prêt à structurer votre prochain projet d'envergure ? Collaborons pour bâtir 
			  des infrastructures résilientes, performantes et parfaitement alignées sur 
          ...
          <MagneticButton
            as="a"
            href="mailto:emericagbo08@icloud.com"
            strength={0.4}
            className="group"
          >
            <span className={cn(
          ...
          {/* Email flip */}
          <div className="mt-12">
            <FlippingEmail email="emericagbo08@icloud.com" />
          </div>
		  {/* Email flip */}
          <div className="mt-12">
            <FlippingTel email="(+225)_________" />
          </div>
          ...
          <div className="mt-16 flex items-center gap-6 flex-wrap justify-center">
            {[ "LinkedIn"].map((social) => (
              <MagneticButton
                key={social}
                as="a"
                href="https://www.linkedin.com/in/emeric-agbo-318539307"
                strength={0.5}
              >
      ...
      <div className="relative z-10 w-full py-8 border-t border-white/10">
        <div className="swiss-container">
          <div className="flex flex-col items-center justify-center gap-2 text-center">
            ...
            <p className="font-nohemi text-xs text-white/40">
              portfolio: architecte | Designed & Built with ♥ and lots of ☕
            </p>
          </div>
        </div>
      </div>
