    ...
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
         ...
         <g filter="url(#gridGlow)" className="animate-grid-intersect">
		  {/* Coins principaux */}
		  <circle cx="25%" cy="25%" r="5" fill="rgba(255,255,255,0.45)" />
		  <circle cx="75%" cy="25%" r="4" fill="rgba(255,255,255,0.35)" />
		  <circle cx="25%" cy="75%" r="4" fill="rgba(255,255,255,0.35)" />
		  <circle cx="75%" cy="75%" r="5" fill="rgba(255,255,255,0.45)" />

		  {/* Centre */}
		  <circle cx="50%" cy="50%" r="6" fill="rgba(255,255,255,0.4)" />

		  {/* ✨ NOUVELLES BOULES */}
		  <circle cx="50%" cy="25%" r="3.5" fill="rgba(255,255,255,0.3)" />
		  <circle cx="50%" cy="75%" r="3.5" fill="rgba(255,255,255,0.3)" />

		  {/* Halo subtil (effet glow doux) */}
		  <circle cx="50%" cy="50%" r="10" fill="rgba(255,255,255,0.06)" />
		</g>
        </svg>
      </div>
 ...
 const words = [
  ...
  <div className="relative group">
    ...
    <img
      ...
      alt="profile"
      className="
        w-[280px] h-[280px] mt-10 rounded-full object-cover 
    ...
    />
        ...
        <p
  className="font-nohemi text-sm md:text-base font-medium uppercase tracking-[0.3em] text-white/90 mb-6"
  style={{
    opacity: mounted ? 1 : 0,
...
{/* Main headline */}
<h1
  className="font-harmond text-5xl sm:text-6xl md:text-7xl lg:text-[8rem] xl:text-[6rem] font-bold tracking-tight leading-[0.85] text-white"
  style={{
    opacity: mounted ? 1 : 0,
    transform: mounted ? 'translateY(0)' : 'translateY(30px)',
...
>
  Ingénieur Génie Civil • Dessinateur 2D-3D
</h1>
